...
def test_run_1m_queries():
    ...
    # Generate DDL for default schema
    print("[Load Test] Generating schema...")
    ddl_stmts = rqg.generate_complex_ddl(num_tables=5)
    ...
    # Give DB a moment to settle if needed, though DDL is synchronous
    ctx = SchemaAwareContext(dsn, seed=42)
