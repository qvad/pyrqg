...
g.rule("column1", choice(*(all_columns + ["col1", "col2", "col3", "field1", "field2"])) if all_columns else "id")
g.rule("column2", choice(*(all_columns + ["val1", "val2", "val3", "attr1", "attr2"])) if all_columns else "id")
